...
/**
 * @OA\Schema(required={"codigo", "codigo_tipo", "codigo_pessoa"}, @OA\Xml(name="PersonProvider"))
 */

class PersonProvider implements JsonSerializable
{
    /**
     * @OA\Property()
     * @var int
    ...
    public function __construct(?int $codigo, ?int $codigo_tipo, ?int $codigo_pessoa)
    {
        $this->codigo = $codigo;
